...
csv_file_path = 'credit-card-approval-prediction/credit_record.csv'

df = pd.read_csv(csv_file_path)
print(df.head())

# curl ifconfig.me --- gives the public ip 
...
import mysql.connector
import logging
from tqdm import tqdm # this library is used to create the bar while the process is ongoing
...
# this code is to validate if the database is created and values are inserted
